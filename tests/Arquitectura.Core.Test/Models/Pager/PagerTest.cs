using Arquitectura.Core.Models.Pager;
using Arquitectura.Core.Test.Helpers.Context;
using Arquitectura.Core.Test.Helpers.Extensions;
...
namespace Arquitectura.Core.Test.Models.Pager
{
    /// <summary>
